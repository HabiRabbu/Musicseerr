				...
				<ul class="menu w-full grow p-2">
					...
					<li>
						<button 
							...
							data-tip="Search"
						>
							<svg xmlns="http://www.w3.org/2000/svg" class="inline-block size-5 my-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
					...
					<li>
						<a 
							...
							data-tip="Home"
						>
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-linejoin="round" stroke-linecap="round" stroke-width="2" fill="none" stroke="currentColor" class="inline-block size-5 my-1.5">
