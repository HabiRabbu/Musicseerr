...
from core.dependencies import JellyfinLibraryServiceDep, LocalFilesServiceDep, PlaylistServiceDep
...
async def get_playlist(
    ...
    cover_urls = list(dict.fromkeys(t.cover_url for t in tracks if t.cover_url))[:4]
