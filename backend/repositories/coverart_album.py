        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if not _is_valid_image_content_type(content_type):
                    ...
                    task = asyncio.create_task(self._write_disk_cache(file_path, content, content_type))
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if not _is_valid_image_content_type(content_type):
                    ...
                    return None
                content = response.content
                task = asyncio.create_task(self._write_disk_cache(cache_path, content, content_type))
                task.add_done_callback(_log_task_error)
                return (content, content_type)
        except Exception as e:
